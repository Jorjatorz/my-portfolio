...
function Summary() {
    return (
        <section className='h-screen w-full mx-auto flex flex-col text-center justify-center'>
            ...
            <p className='text-xl m-16'>Hello! I am a Software engineer with focus on Machine Learning and with experience in consulting.
